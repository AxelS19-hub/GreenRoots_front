...
// Open activity modal functionality
function openActivityModal() {
    showNotification('Abriendo formulario de creación de evento...', 'info');
    ...
    modal.innerHTML = `
        <div class="modal-content">
            <div class="modal-header">
                <h3><i class="fas fa-calendar-plus"></i> Crear Nuevo Evento</h3>
            ...
            <div class="modal-body">
                <form id="activityForm">
                    <div class="form-group">
                        <label><i class="fas fa-tag"></i> Nombre de la Actividad</label>
                        <input type="text" name="activityName" required placeholder="Ej: Jornada de Plantación">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="activityLocation" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="activityDescription" rows="3" placeholder="Descripción de la actividad..."></textarea>
                    </div>
                    <div class="form-group">
                        <label><i class="fas fa-paperclip"></i> Instrucciones (JPG, PNG, PDF)</label>
                    ...
                    <div class="form-actions">
                        <button type="button" onclick="closeActivityModal()" class="cancel-btn">Cancelar</button>
    ...
    const modalStyles = `
        ...
        .file-upload-area.dragover {
            border-color: var(--accent-green);
            background: rgba(107, 163, 135, 0.05);
        }
        ...
        .activity-modal .cancel-btn,
        .activity-modal .submit-btn {
        ...
        .activity-modal .cancel-btn:hover,
        .activity-modal .submit-btn:hover {
    ...
    if (!document.getElementById('activity-modal-styles')) {
        ...
        style.id = 'activity-modal-styles';
    ...
    document.getElementById('activityForm').addEventListener('submit', function(e) {
        ...
        governmentActivities.push(newActivity);
        localStorage.setItem('governmentActivities', JSON.stringify(governmentActivities));
...
function initializeFileUpload() {
    ...
    function handleFiles(files) {
        Array.from(files).forEach(file => {
            ...
            if (file.size > 10 * 1024 * 1024) {
                showNotification(`Archivo muy grande: ${file.name}`, 'error');
                return;
            }
    ...
    function displayFile(file) {
        ...
        const icon = fileType === 'image' ? 'fa-image' : 'fa-file-pdf';
        
        fileItem.innerHTML = `
            <div class="file-info">
                <i class="fas ${icon} file-icon ${fileType}"></i>
    ...
    window.removeFile = function(fileName) {
        ...
        fileItems.forEach(item => {
            if (item.querySelector('h5').textContent === fileName) {
                item.remove();
            }
        });
    };
