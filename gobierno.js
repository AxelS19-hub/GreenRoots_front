...
function scheduleActivity() {
    showNotification('Abriendo formulario de programación de actividades...', 'info');
    
    // Create activity scheduling modal
    const modal = document.createElement('div');
    modal.className = 'activity-modal';
    modal.innerHTML = `
        <div class="modal-content">
            <div class="modal-header">
                <h3><i class="fas fa-calendar-plus"></i> Agendar Nueva Actividad</h3>
            ...
            <div class="modal-body">
                <form id="activityForm">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="submit-btn">Programar Actividad</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    document.getElementById('activityForm').addEventListener('submit', function(e) {
        e.preventDefault();
        showNotification('Actividad programada exitosamente', 'success');
        closeActivityModal();
    });
